...
function example4(divId) {
    ...
    let rowData2 = [['Month', 'Bolivia', 'Ecuador', 'Madagascar', 'Papua  Guinea',
                     'Rwanda', 'Average'],
    ...
    let chart = new google.visualization.ComboChart(document.getElementById(divId));
    let button = document.getElementById(divId);
    function drawChart() {
